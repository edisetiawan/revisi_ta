...
$arr=tampilBuku();    
    foreach($arr as $key=>$value)
    {
       ...
       <?php  } ?>
          ...
          <a href="detail_buku&id=<?php echo $data['kode_buku'];?>" class="thumbnail"><img class="img-responsive" src="images/<?php echo $value['foto_buku']; ?>" alt="Thumb21"></a>
          </div>
  <?php  } ?>
</div>
</div>
                        ...
                        <div class="row">
                           ...
                           ?>
                             <div class="col-xs-6 col-md-3 img-portfolio">
                                <a href="?page=detail_buku&id=<?php echo $data['kode_buku']; ?>">
                                    <img class="img-responsive img-hover thumbnail" src="images/<?php echo $data['foto_buku'] ?>" alt=""></a>
                                <h4>
